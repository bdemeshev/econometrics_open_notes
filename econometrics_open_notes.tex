...
% TODO: 1 - RSS/TSS. разница определений без константы
...
% TODO: оптимизация функций в матрицах или дифференциалах (или и так, и так?)
% дифференциалы в ЧЁТРЭК
...
% Например, вектор весов $w_1 = \col_1 W$, с которыми наблюдения $y_1$, $y_2$, \dots, $y_n$ входят в оценку $\hb_1$, лежит в линейной оболочке $\Span(\col_1 X, \col_2 X, \dots, \col_k X)$.
...
% TODO: цепочка центрирование - унарная регрессия даёт парную, это не случайно.
...
% набор свойств R2 через частную корреляцию
